          ...
          <>
            <div>
              ...
              <div className="mt-2 space-y-2">
                {goals.map((g) => {
                  const pct = g.target_amount > 0 ? Math.min(100, (safeNum(g.current_amount) / g.target_amount) * 100) : 0;
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="text-xs text-slate-500 mt-1">{formatMoney(g.current_amount)} из {formatMoney(g.target_amount)}</p>
                    </button>
                  );
                })}
              </div>
